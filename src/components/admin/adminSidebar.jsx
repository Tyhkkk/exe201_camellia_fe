  ...
  return (
    <div className="h-full w-auto bg-white shadow-lg flex flex-col p-4">
      ...
      <nav className="flex-grow space-y-4">
        ...
        <Link to="/admin/example-pages" className="flex items-center px-4 py-2 rounded-lg hover:bg-blue-100">
      ...
      <div className="mt-auto">
        <button className="flex items-center px-4 py-2 text-red-500 hover:bg-red-100 rounded-lg w-full">
