    ...
    <div className="container mx-auto py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
        ...
        <div className="flex flex-col justify-center text-[#7b3d35]">
          ...
          <p className="text-lg  mb-6 text-[#7b3d35]">
          ...
          <a
            href="/story"
            className="px-6 py-2 mt-4 w-40 text-center border border-[#6e3a3a] text-[#6e3a3a]  hover:bg-[#6e3a3a] hover:text-white transition duration-300"
          >
            See it now
          </a>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-4xl font-bold mb-4 text-b37572 text-[#7b3d35]">Proudly Vietnamese Brand</h2>
          <p className="text-lg text-[#7b3d35] mb-6">
